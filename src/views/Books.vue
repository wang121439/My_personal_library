...
<!-- 导航 -->
  ...
  <van-col span="4">
    ...
    <b>淘书团</b></router-link></van-col>
  <van-col span="4">
    <router-link to="#">
    <img src='../assets/img/page/books_mail.png' alt='9.9包邮'/>
    <b >9.9包邮</b></router-link></van-col>
  <van-col span="4">
    <router-link to="#">
    <img src='../assets/img/page/books_new.png' alt='新上架'/>
    <b>新上架</b></router-link></van-col>
  <van-col span="4">
    <router-link to="#">
    <img src='../assets/img/page/books_publish.png'  alt='出版社'/>
    <b>出版社</b></router-link></van-col>
</van-row> </div>
<!-- 导航 -->
...
<van-row>
  <van-col span="6">
    <img src="../assets/img/books_message.png" alt="" style="width:60px;border-radius: 5px;margin: 8px 6px;">
  </van-col>
  <van-col span="18">
    <van-notice-bar left-icon="volume-o" :scrollable="false" style="color:red;background-color:#FFF;right: 24px;">
<van-swipe
  vertical
  class="notice-swipe"
  :autoplay="3000"
  :show-indicators="false">
  <van-swipe-item class="ellipsis"> <router-link to="#">辛丑年新春书市|每满79减30（附送手帐本1个）</router-link> </van-swipe-item>
  <van-swipe-item class="ellipsis"> <router-link to="#">疫情期间发货公告</router-link></van-swipe-item>
  <van-swipe-item class="ellipsis"> <router-link to="#">新用户注册即送10元!</router-link></van-swipe-item>
</van-swipe>
</van-notice-bar>
  </van-col>
</van-row>
